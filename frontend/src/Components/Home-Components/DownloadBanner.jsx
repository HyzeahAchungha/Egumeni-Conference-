                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="p-6 sm:p-12 text-white">
                            ...
                            <div className="mt-6 flex gap-3">
                                <button className="rounded-md bg-[#245da8] hover:bg-[#1d4e8f] text-white text-sm px-3 py-2 shadow">For Android</button>
                                <button className="rounded-md bg-white/95 hover:bg-white text-gray-900 text-sm px-3 py-2 shadow">For iPhone</button>
                            </div>
                        </div>
