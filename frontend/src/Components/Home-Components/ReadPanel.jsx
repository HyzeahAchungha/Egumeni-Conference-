            ...
            <div className="rounded-[10px] overflow-hidden shadow-sm border border-black/10 relative">
                ...
                <div className="absolute inset-0 p-6 text-white flex flex-col justify-end">
                    ...
                    <div className="mt-3 flex gap-3">
                        <button className="rounded-md bg-[#245da8] hover:bg-[#1d4e8f] text-white text-sm px-3 py-1.5 shadow">New summary on TFGBV</button>
                        <button className="rounded-md bg-white/95 hover:bg-white text-gray-900 text-sm px-3 py-1.5 shadow">All resources</button>
                    </div>
                </div>
            </div>
        </div>
